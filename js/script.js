...
class SimpleSearch {
    ...
    loadSearchData() {
        this.searchData = [
            ...
            // MDK
        {
            title: "МДК 05.01: Проектирование и дизайн информационных систем",
            content: "Проектирование и дизайн информационных систем. Методологии проектирования, разработка ТЗ, этапы создания ИС.",
            url: "mdk/mdk05.html",
            type: "mdk"
        },
        {
            title: "Тема 1: Основные понятия и история развития",
            content: "Основные понятия технологии проектирования информационных систем. История развития и современное состояние.",
            url: "mdk/mdk05-topic1.html",
            type: "mdk"
        },
        {
            title: "Тема 2: Разработка ТЗ. Этапы создания",
            content: "Разработка технического задания, эскизного и технического проекта. Этапы проектирования ИС.",
            url: "mdk/mdk05-topic2.html",
            type: "mdk"
        },
